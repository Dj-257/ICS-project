...
void aStarMaze(int maze[][100], int N) {
    ...
    Node nodes[100][100];  // Use a large enough size for nodes
    int openList[100][100] = {0};
    int closedList[100][100] = {0};
...
int main() {
    ...
    // The maze generation code would go here
